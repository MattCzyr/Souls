...
@Mod(modid = Souls.MODID, name = Souls.NAME, version = Souls.VERSION, acceptedMinecraftVersions = "[1.12.2]")
...
public class Souls {
    ...
    public void registerItems(RegistryEvent.Register<Item> event) {
        Item enderJewel = new Item().setUnlocalizedName(Souls.MODID + ".ender_jewel").setCreativeTab(CreativeTabs.MATERIALS);
        Item soulIdentifier = new ItemSoulIdentifier();
        ItemPickpocketGauntlet pickpocketGauntlet = new ItemPickpocketGauntlet(16, ConfigHandler.pickpocketSuccessRate, "pickpocket_gauntlet");
        ItemPickpocketGauntlet creativePicketpocketGauntlet = new ItemPickpocketGauntlet(9999, 100.0D, "creative_pickpocket_gauntlet");
